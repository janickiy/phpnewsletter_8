...
@section('css')
    ...
    <style>
        ...
        .category-page #itemList th,
        .category-page #itemList td {
            vertical-align: middle;
        }

        .category-page #itemList thead th {
            white-space: nowrap;
        }
    </style>
            ...
            $('#itemList').on('click', 'a.deleteRow', function () {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '{{ url('category/destroy') }}/' + rowid,
                            type: "POST",
                            dataType: "html",
                            data: {_method: 'DELETE'},
